 ...
 * @version 9/24/2015
 */
public class ArraySortStringComparator implements Comparator<String> {

	@Override
	public int compare(String o1, String o2) {
		if((AnagramUtil.sortUsingArraySortMethod(o1)).compareTo(AnagramUtil.sortUsingArraySortMethod(o2)) < 0) {
			return -1;
		}
		else {
			return 1;
