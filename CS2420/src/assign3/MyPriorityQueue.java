...
/**
 * An implementation of Priority Queue, this class will take a sorted list 
 * of a generic type and perform enque/deque operations using binary sort
 * 
...
public class MyPriorityQueue<E> implements PriorityQueue<E> {
	 ...
	 * Provides separate comparison logic depending on which constructor was used 
	 * @param e1
	 * @param e2
	 * @return
	 */
